...
{if ("" != null) return l;}
  ...
  final public AstNode bitAnd() throws ParseException {Token tok;
    AstNode l, r;
    l = shift();
    label_11:
    while (true) {
...
{if ("" != null) return l;}
  ...
  final public AstNode bitXor() throws ParseException {Token tok;
    AstNode l, r;
    l = bitAnd();
    label_12:
    while (true) {
...
{if ("" != null) return l;}
  ...
  final public AstNode bitOr() throws ParseException {Token tok;
    AstNode l, r;
    l = bitXor();
    label_13:
    while (true) {
